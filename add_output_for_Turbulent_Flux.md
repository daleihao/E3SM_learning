...
export COMPILER=intel 
export MACH=compy 
export CASE_NAME=TurbulentFlux_notop_${RES}.${COMPSET}.${COMPILER}
cd ~/e3sm_top/cime/scripts 
./create_newcase -compset ICLM45 -res ${RES} -case ${CASE_NAME} -compiler ${COMPILER} -mach ${MACH} -project ESMD 
cd ${CASE_NAME}
./xmlchange LND_DOMAIN_FILE=domain_ARM_SGP_c201206.nc 
...
./xmlchange NTASKS=1,STOP_N=1,STOP_OPTION=nmonths,JOB_WALLCLOCK_TIME="10:00:00",RUN_STARTDATE="2009-06-01",REST_N=1,REST_OPTION=nmonths
./xmlchange DATM_MODE="CLMGSWP3v1",DATM_CLMNCEP_YR_START='2000',DATM_CLMNCEP_YR_END='2010'

cat >> user_nl_clm << EOF
finidat = '/compyfs/haod776/e3sm_scratch/spinup_11years_CLM_USRDAT.ICLM45.intel/run/spinup_11years_CLM_USRDAT.ICLM45.intel.clm2.r.2011-01-01-00000.nc'
rad_3d_topo = .false.
f3dtopo = ''
hist_empty_htapes = .true.
hist_fincl1 = 'zeta_patch', 'ustar_patch','LH_pft', 'SH_pft','TBOT','QBOT','RHO','EFLX_LH_TOT','Qh','FV'
...
export COMPILER=intel 
export MACH=compy 
export CASE_NAME=TurbulentFlux_top_${RES}.${COMPSET}.${COMPILER}
cd ~/e3sm_top/cime/scripts 
./create_newcase -compset ICLM45 -res ${RES} -case ${CASE_NAME} -compiler ${COMPILER} -mach ${MACH} -project ESMD 
cd ${CASE_NAME}
./xmlchange LND_DOMAIN_FILE=domain_ARM_SGP_c201206.nc 
...
finidat = '/compyfs/haod776/e3sm_scratch/spinup_11years_CLM_USRDAT.ICLM45.intel/run/spinup_11years_CLM_USRDAT.ICLM45.intel.clm2.r.2011-01-01-00000.nc'
rad_3d_topo = .true.
f3dtopo = '/qfs/people/haod776/script_for_clm_sparse_grid/clm-netcdf/topodata_ARM_SGP_c201206.nc'
hist_empty_htapes = .true.
hist_fincl1 = 'zeta_patch', 'ustar_patch','LH_pft', 'SH_pft','TBOT','QBOT','RHO','EFLX_LH_TOT','Qh','FV'
hist_fincl2 = 'FSH','EFLX_LH_TOT','Qh'
hist_nhtfrq = 1, -24
